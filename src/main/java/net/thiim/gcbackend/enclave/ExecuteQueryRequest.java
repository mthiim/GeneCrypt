...
public class ExecuteQueryRequest {
	public String encryptedGenome;
	public String encryptedGenomeKey; // The genome decryption key, encrypted under the session key 
	public String encryptedGenomeIV;
}
